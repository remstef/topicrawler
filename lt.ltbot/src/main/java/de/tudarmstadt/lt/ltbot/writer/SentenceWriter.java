...
public class SentenceWriter extends Processor{
	...
	public String report() {
		...
		b.append(String.format("  %-30.30s %d %n", "Number of Sentence Bytes written: ", _num_bytes_sentences_written.get()));
		b.append(String.format("  %-30.30s %.3f %n", "Number of Sentence MBytes written: ", _num_bytes_sentences_written.get() / (1000d * 1000d)));
		b.append(String.format("  %-30.30s %.3f %n", "Number of Sentence GBytes written: ", _num_bytes_sentences_written.get() / (1000d * 1000d * 1000d)));
