...
save for a particular ngram the number of words that follow an ngram at least once, twice and three times or more
...
def mapper(lines):
    for line in lines:
        ...
        if len(ngram) > 1:
            print('{}\t{}\t{}'.format(' '.join(ngram[:-1]), num, ngram[-1]))
    ...
    for ngram, tuples in it.groupby(redline2tuple(lines), lambda t : t[0]):
        ...
        for tuple_ in tuples:
            ...
            if num == 1:
                ...
                N3p += 1
        print('{}\tn_f:{},{},{},{}'.format(ngram,n,N1,N2,N3p))
